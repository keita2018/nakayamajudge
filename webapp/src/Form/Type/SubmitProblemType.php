...
class SubmitProblemType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('code_text', TextareaType::class, [
            'label' => 'Or paste your code (optional)',
            'required' => false,
            'attr' => [
                'rows' => 18,
                'spellcheck' => 'false',
                'style' => 'font-family: monospace;',
                'placeholder' => "Paste your solution source here.\nIf you use this, you don't need to upload a file/ZIP.",
            ],
            'help' => 'When provided, a temporary source file will be created using a suitable extension for the selected language.',
        ]);
